...
export const MISSING_PUBLIC_COLUMNS =
  "id,name,age,description,last_seen_location,state,municipality,parish,last_seen_lat,last_seen_lng,photo_url,status,report_date,found_date,source_id,source_label,source_url,created_at,updated_at";
